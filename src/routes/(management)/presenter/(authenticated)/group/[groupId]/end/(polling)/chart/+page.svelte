...
<div class="join-note">
	...
	<strong class="spaced">{data.group.endPollCode}</strong>
</div>
<h1 class="title">Our Collective Ending Point</h1>
...
<PresentationFooter
	...
	numLabel="Responses"
	onNext={data.matchingResults.length > 0
		? () => goto(`/presenter/group/${data.group._id}/end/comparison`)
		: null}
	onPrev={() => goto(`/presenter/group/${data.group._id}/end`)}
/>
